    ...
    <v-form ref="form">
        <v-card height="100vh">
            ...
            <v-file-input  label="label"
                    v-model="tempValue" clearable  rows="4" show-size="1024" accept="image/png, image/jpeg, image/bmp" row-height="30" @change="onFileSelected(tempValue)" :rules="tempValue? [rules.fileSize]: [rules.fileRequired]">
                </v-file-input>
